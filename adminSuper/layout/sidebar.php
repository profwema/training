		<!-- start: LEFT SIDEBAR -->
		<div id="page-sidebar">
			<a class="sidebar-toggler sb-toggle" href="#"><i class="fa fa-outdent"></i></span>
			...
			<div class="sidebar-wrapper">
				<ul class="nav nav-tabs nav-justified" id="sidebar-tab">
					<li class="active">
						<a href="#users" role="tab" data-toggle="tab"><i class="fa fa-users"></i></span>
								<span class="selected"></span>
							</a>
						</li>
					</li>
					<li>
						<a href="#favorites" role="tab" data-toggle="tab"><i class="fa fa-heart"></i></span>
								<span class="selected"></span>
							</a>
						</li>
					</li>
					<li>
						<a href="#settings" role="tab" data-toggle="tab"><i class="fa fa-gear"></i></span>
								<span class="selected"></span>
							</a>
						</li>
					</li>
					...
					<div class="tab-pane active" id="users">
						...
						<div class="user-chat">
							<div class="sidebar-content">
								<a class="sidebar-back" href="#"><i class="fa fa-chevron-circle-left"></i> Back</span>
								<span class="selected"></span>
							</a>
						</li>
							</div>
