    ...
    <div class="container">
        ...
        <div class="row" style="direction:rtl;text-align:right;">
            ...
            <div class="col-sm-12 col-md-3 mb-30">
                ...
                <!-- Title -->
                <h3 class="title m_title in-view">
                    تواصل معنا
                </h3>
                ...
                <div class="contact-details">
                    <p>
                        <strong>3317928 040 2+</strong><br> الإيميل: <a href="#">tanta_unv@unv.tanta.edu.eg</a>
                    </p>
                    ...
                    <p>
                        <a href="https://goo.gl/maps/Vj4B7ywTxL2pbgRm9" target="_blank">
                            <i class="fa fa-map-marker-alt"></i> المكان الجغرافى
                        </a>
                    </p>
                    <p>
                        <a href="https://ask.tanta.edu.eg/" target="_blank">
                            <i class="fa fa-question"></i> منظومة الاستفسارات والمقترحات
            ...
            <div class="col-sm-12 col-md-6 mb-30">
                <div class="newsletter-signup">
                    ...
                    <div action="#" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form"
                        class="validate" target="_blank" novalidate="">


                        <input name="FooterUserControl$TextBox_Email" type="text" id="FooterUserControl_TextBox_Email"
                            class="nl-email form-control" placeholder="your.address@email.com" />
                        <input type="submit" name="FooterUserControl$Button_Subscribe" value="إشترك الآن"
                            id="FooterUserControl_Button_Subscribe" class="nl-submit" />
                    ...
                    <p>
                        <a href="https://maps.tanta.edu.eg/" target="_blank">
                            <i class="fa fa-map-marker-alt"></i> الدليل الجغرافى للجامعة
                        </a>
                    </p>
                </div>
            ...
            <div class="col-sm-12 col-md-3 mb-30">
                ...
                <div class="sbs">
                    <ul style="line-height:40px;list-style:none">
                        ...
                        <li><a href="http://tdb2.tanta.edu.eg/paymentgateway/e_payment/" target="_blank">نظام التحصيل
                                الإلكتروني</a></li>
                        <li><a href="files/Professional-Conduct.pdf">مدونة السلوك الوظيفي</a></li>
                        <li><a href="cong.aspx">مجلس الجامعة</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <ul class="list-inline p-0">
                                ...
                                <li class="list-inline-item">
                                    <a href="tel:01007256688"> <i class="fa fa-phone ml-2"></i> 01007256688</a>
                                </li>
                                <li class="list-inline-item">|</li>
                                <li class="list-inline-item">
                                    <a href="mailto:tanta_portal@unv.tanta.edu.eg"> <i class="fa fa-envelope ml-2"></i>
                                        tanta_portal@unv.tanta.edu.eg</a>
                                </li>
                        ...
                        <div class="col-md-6">
                            <ul class="list-inline p-0 text-left">
                                ...
                                <li class="list-inline-item">|</li>
                                <li class="list-inline-item"><a href="https://tanta.edu.eg/Content-policy.aspx">سياسة
                                        المحتوى</a></li>
                            </ul>
                        </div>
                    </div>
